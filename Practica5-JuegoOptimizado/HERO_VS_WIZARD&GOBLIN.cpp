...
void gamestarter() {
    ...
    goblinalive, heroalive, wizardalive = true;
}

void attackFunc(int& hpentity, int& dmgentity) {
    hpentity = hpentity - dmgentity;
}
